...
def generate_launch_description():
    ...
    slamtoolbox_pure_launch = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(
            os.path.join(get_package_share_directory('agent_dawgs'), 'launch', 'slamtoolbox_pure_launch.py')
        )
    )
    ...
    ld.add_action(slamtoolbox_pure_launch)
