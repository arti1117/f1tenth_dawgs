...
options = {
  ...
  map_frame = "map",
  tracking_frame = "laser",  -- Changed from "base_link" to "laser" for better scan matching
  published_frame = "odom",		-- "forza: base_link"
  odom_frame = "odom",
  ...
  num_point_clouds = 0,
  lookup_transform_timeout_sec = 0.5,  -- Increased from 0.2 for more reliable TF lookup
  submap_publish_period_sec = 0.3,
  pose_publish_period_sec = 5e-3,
  trajectory_publish_period_sec = 30e-3,
  rangefinder_sampling_ratio = 1.,
  odometry_sampling_ratio = 1.,	-- forza 0.5
